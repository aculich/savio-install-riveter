...
PYTHON_VERSION="3.6" # Adjust Python version to ensure compatibility
...
conda create -y -n "$ENV_NAME" python="$PYTHON_VERSION" || { echo "Failed to create Conda environment"; exit 1; }
